...
[release](https://github.com/cgohlke/geospatial-wheels/releases/tag/v2024.1.1):

- [basemap](https://pypi.org/project/basemap/) 1.3.9
...
- [GDAL](https://pypi.org/project/GDAL/) 3.8.2
...
- [c-ares](https://c-ares.org/download/c-ares-1.24.0.tar.gz) 1.24.0
...
- [curl](https://curl.se/download/curl-8.5.0.tar.gz) 8.5.0
...
- [gdal](https://github.com/OSGeo/gdal) 3.8.2
...
- [libjxl](https://github.com/libjxl/libjxl) 0.9.0
...
- [openexr](https://github.com/AcademySoftwareFoundation/openexr) 3.2.1
- [openjpeg](https://github.com/uclouvain/openjpeg) 2.5.0
- [openssl](https://github.com/openssl/openssl) 3.0.12
- [pcre2](https://github.com/PCRE2Project/pcre2.git) 10.42
- [postgresql](https://ftp.postgresql.org/pub/source/v15.5/postgresql-15.5.tar.gz) 15.5
...
- [sqlite](https://github.com/sqlite/sqlite) 3.44.2
