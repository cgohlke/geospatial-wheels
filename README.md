...
[release](https://github.com/cgohlke/geospatial.whl/releases/tag/v2023.7.16):
...
Binary wheels for the following packages are included in the
[release](https://github.com/cgohlke/geospatial.whl/releases/tag/v2023.4.22):
...
Binary wheels for the following packages are included in the
[release](https://github.com/cgohlke/geospatial.whl/releases/tag/v2023.1.10.1):
